...
<link href="../fontawesome/css/all.css" rel="stylesheet">
    ...
    <style>
        body {
            background-color: #3498db; /* Set your desired shade of blue */
            color: #fff; /* Set text color to white or another suitable color for visibility */
        }
    </style>
  </head>
  <body>
...
<?php endif; ?>
              ...
              <hr>
                <div class="form-group">
                  <label><h5 class="text-info">Username</h5></label>
                  <input type="text" class="form-control" name="username" id="username" placeholder="Masukkan Username" required>
                </div>

                <div class="form-group">
                  <label><h5 class="text-info">Password</h5></label>
          ...
          <div class="text-center" style="margin-top: 15px">
          	Login Sebagai <a href="siswa/login-siswa.php" style="color: black;"> Siswa</a>
          </div>
